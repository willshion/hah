        ...
        for (var m = j; m !== b; m = m + l) {
            ...
            if (i.render) {
                ...
                if (h)
                    ...
                    i = i[c];
                    if (!i)
                        continue;g && G.setBlending(i.blending, i.blendEquation, i.blendSrc, i.blendDst);
        ...
        for (var h, i, j = 0, k = a.length; j < k; j++) {
            ...
            if (i.visible) {
                if (g)
                    ...
                    h = h[b];
                    if (!h)
                        continue;f && G.setBlending(h.blending, 
            ...
            for (c = b.length; j < c; j++)
                if (l = f.uniforms[b[j][1]]) {
                    ...
                    case "t":
                        ...
                        l = h.texture;
                        if (!l)
                            continue;if (l.image instanceof Array && l.image.length === 6) {
                            h = l;
                            if (h.image.length === 6)
                                if (h.needsUpdate) {
